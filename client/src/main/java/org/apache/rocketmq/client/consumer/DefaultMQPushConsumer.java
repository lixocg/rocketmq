...
public class DefaultMQPushConsumer extends ClientConfig implements MQPushConsumer {
     ...
     * 表示消息处理队列中偏移量最大的消息与偏移量最小的消息跨度超过2000，则延迟50ms再拉取消息
     */
    private int consumeConcurrentlyMaxSpan = 2000;

    /**
     * 默认1000，每1000次流控后打印流控日志
     */
    ...
    /**
     * 推模式下来取任务间隔时间，默认一次拉取任务完成继续拉取
     */
    private long pullInterval = 0;

    /**
     * 消息并发消费时一次消费消息条数，通俗来说就是每次传入MessageListener#consumeMessage中的消息条数
     */
    ...
    /**
     * 最大消息重试次数，如果消息重试次数超过maxReconsumeTimes还未成功，则讲该消息转到一个失败队列中，等待删除
     */
